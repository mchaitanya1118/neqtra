    ...
    <nav className="fixed top-0 w-full z-50 border-b border-foreground/5 bg-background/80 backdrop-blur-md">
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          {!isAuthenticated ? (
            <Link href="/login">
              <Button className="text-sm font-bold bg-primary text-white hover:bg-primary/90">Sign In</Button>
            </Link>
          ) : (
            <Link href="/console">
        ...
        {isOpen && (
          ...
          >
            <div className="container mx-auto px-6 py-6 flex flex-col gap-4">
              ...
              {!isAuthenticated ? (
                <Link href="/login">
                  <Button className="w-full bg-primary text-white font-bold hover:bg-primary/90">Sign In</Button>
                </Link>
              ) : (
                <Link href="/console">
