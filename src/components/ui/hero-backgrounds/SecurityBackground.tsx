    ...
    return (
        <div className="absolute inset-0 bg-[#0b0f19] overflow-hidden flex items-center justify-center">
            ...
            <motion.div
                ...
                className="absolute w-[800px] h-[800px] border border-white/10 rounded-full border-dashed"
            />
            <motion.div
                animate={{ rotate: -360 }}
                transition={{ duration: 45, repeat: Infinity, ease: "linear" }}
                className="absolute w-[600px] h-[600px] border border-white/5 rounded-full border-dotted"
            />
            <motion.div
                animate={{ rotate: 180 }}
                transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
                className="absolute w-[400px] h-[400px] border-2 border-white/10 rounded-full opacity-50"
            />
            ...
            {/* Scanning Line */}
            <motion.div
                className="absolute w-full h-[2px] bg-gradient-to-r from-transparent via-white/20 to-transparent blur-sm"
                animate={{ top: ["0%", "100%"] }}
